...
public class IceClient
{
    ...
    private String[] turnServers = new String[]{"jitsi.org:3478"};
    private String[] stunServers = new String[]{"jitsi.org:3478"};
                                        ...
                                        Agent agent) throws Throwable
    {
        ...
        // rtp
        Component component = agent.createComponent(stream, rtpPort, rtpPort, rtpPort + 100); //Transport.UDP,
